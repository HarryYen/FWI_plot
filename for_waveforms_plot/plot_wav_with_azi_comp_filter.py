...
def wav_preprocessing(tr):
    ...
    tr.filter('bandpass', freqmin=1/period_max, freqmax=1/period_min, corners=4, zerophase=True)
...
if __name__ == '__main__':
    ...
    # ---------------- PARAMETER -----------------#
    model_ref, model_final = 0, 22
    period_min, period_max = 10, 30
    ...
    wav_start_time = -30.
    output_dir = '/home/harry/Work/Adjoint_tomography_old_dataset/FWI_result_gutenberg_1/waveform_with_azi_filter'
    # --------------------------------------------#
